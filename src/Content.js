                ...
                {detailMovies.map(movie => 
                    <div className="animate__animated animate__fadeIn px-4 py-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-8 mt-1">
                        <div className="grid gap-5 row-gap-10 lg:grid-cols-2">
                            ...
                            <div>
                                <iframe className="object-cover w-full h-56 rounded shadow-lg sm:h-96" src={movie.trailer} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                            </div>
                        </div>
                    </div>
                )}
