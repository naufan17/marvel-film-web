...
export default function Content({id}){
    ...
    if(isLoading === true){
        ...
        return(
            <div key={movies.id} className="animate__animated animate__fadeIn px-4 py-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-8 mt-1">
